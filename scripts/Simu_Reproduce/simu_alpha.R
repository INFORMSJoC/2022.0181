...
cal_loss_once <- function(ii) 
{
  ...
  file_name_BC <- paste(set,voutsd, "BC.txt", sep = "_")
  file_path_BC <- paste(path_result, file_name_BC, sep = "")
  
  file_name_rank <- paste(set,voutsd, "rank.txt", sep = "_")
  ...
  file_name_mask <- paste(set,voutsd, "mask.txt", sep = "_")
  file_path_mask <- paste(path_result, file_name_mask, sep = "")
  
  file_name_swamp <- paste(set,voutsd, "swamp.txt", sep = "_")
  file_path_swamp <- paste(path_result, file_name_swamp, sep = "")
  
  file_name_detection <- paste(set,voutsd, "detection.txt", sep = "_")
  file_path_detection <- paste(path_result, file_name_detection, sep = "")
  
  # debug
  file_name_debug <- paste(set,voutsd, "debug.txt", sep = "_")
...
settings <- lapply(voutsd_list, unlist, 1)
