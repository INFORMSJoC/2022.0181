...
cal_loss_once <- function(ii) 
{
  ...
  file_name_BC <- paste(set,nout, "BC.txt", sep = "_")
  file_path_BC <- paste(path_result, file_name_BC, sep = "")
  
  file_name_rank <- paste(set,nout, "rank.txt", sep = "_")
  ...
  file_name_mask <- paste(set,nout, "mask.txt", sep = "_")
  file_path_mask <- paste(path_result, file_name_mask, sep = "")
  
  file_name_swamp <- paste(set,nout, "swamp.txt", sep = "_")
  file_path_swamp <- paste(path_result, file_name_swamp, sep = "")
  
  file_name_detection <- paste(set,nout, "detection.txt", sep = "_")
  file_path_detection <- paste(path_result, file_name_detection, sep = "")
  
  # debug
  file_name_debug <- paste(set,nout, "debug.txt", sep = "_")
...
settings <- lapply(nout_list, unlist, 1)
